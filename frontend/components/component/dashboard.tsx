...
export function Dashboard() {
  return (
    <div className="grid min-h-screen grid-cols-[300px_1fr] w-full">
      ...
      <div className="flex flex-col">
        ...
        <main className="flex-1 flex flex-col p-4 md:p-6">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">New high-severity threats detected</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                <CardTitle className="text-sm font-medium">Incident Response</CardTitle>
                <ActivityIcon className="w-4 h-4 text-gray-500 dark:text-gray-400" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">+3</div>
                <p className="text-xs text-gray-500 dark:text-gray-400">New incidents reported</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
          ...
          <div className=" flex-1 flex flex-col md:py-6">
            <Card>
              <LogTable/>
            </Card>
          </div>
